        ...
        <View className="bg-[#0165fc] text-white p-4 rounded-b-3xl">
          <View className="flex-row items-center justify-between mb-6">
            ...
            <View className="flex-row items-center gap-3">
              ...
              <Image
                source={{ uri: "asset:/user-profile-illustration.png" }}
        ...
        {[
          ...
          <TouchableOpacity
            ...
            className={`flex items-center py-2 px-3 rounded-lg transition-colors ${
              activeTab === tab.id
                ? "text-[#0165fc] bg-blue-50"
                : "text-gray-500"
            }`}
          >
            {tab.id === "add" ? (
              <View className="w-12 h-12 bg-[#0165fc] rounded-full flex items-center justify-center mb-1">
                <tab.icon size={24} color="white" />
              </View>
            ) : (
              <tab.icon
                size={24}
                color={activeTab === tab.id ? "#0165fc" : "gray"}
              />
            )}
            <Text
              className={`text-xs font-medium ${
                activeTab === tab.id ? "text-[#0165fc]" : "text-gray-500"
              }`}
            >
              {tab.label}
            </Text>
